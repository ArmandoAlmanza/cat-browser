...
const CatlistGrid = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto flex flex-col content-center gap-5">
            ...
            <div className="grid grid-cols-2 place-content-center place-items-center border border-gray-200 rounded-2xl gap-4 md:grid-cols-3 p-5">
                {catImages
                    ? catImages.map((catImage, i) => (
                          <img
                              className="min-h-48 max-h-48 max-w-32 md:min-w-48 md:max-w-48"
                              key={i}
                              src={catImage.url}
                              alt="image cat"
                          />
